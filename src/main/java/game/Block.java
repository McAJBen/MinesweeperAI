...
public class Block {
	...
	public static void loadImages() {
		try {
			blank = ImageIO.read(Block.class.getResource("/blank.png"));
			flag = ImageIO.read(Block.class.getResource("/flag.png"));
			hitMine = ImageIO.read(Block.class.getResource("/hitMine.png"));
			mine = ImageIO.read(Block.class.getResource("/mine.png"));
		} catch (IOException e) {
			System.exit(-1);
		}
	}
